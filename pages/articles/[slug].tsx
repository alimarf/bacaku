...
export default function ArticleDetailPage() {
  ...
  return (
    <div>
      <Head>
        <title>{article.title} | Bacaku</title>
      ...
      <div className="w-[720px] mx-auto py-24">
        <div className="flex items-center mb-8">
          ...
          />
          <div>
            <p className="font-sans text-slate-900 mb-1">
              {article.author.name}
            </p>
            <p className="font-sans text-slate-400">{formattedDate}</p>
          </div>
        </div>
        ...
        <img className="w-full aspect-video object-cover mb-12" src={article.thumbnail} alt={article.title} />
